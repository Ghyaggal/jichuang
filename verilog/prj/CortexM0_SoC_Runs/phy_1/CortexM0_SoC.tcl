...
set rc [catch {
  ...
  import_db {../syn_1/CortexM0_SoC_gate.db}
  read_sdc ../../sysclk_adc.sdc
  place
  export_db {CortexM0_SoC_place.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  route
  report_area -io_info -file CortexM0_SoC_phy.area
  export_db {CortexM0_SoC_pr.db}
  start_timer
  report_timing -mode FINAL -net_info  -rpt_autogen true -file CortexM0_SoC_phy.timing
} RESULT]
if {$rc} {
...
set rc [catch {
  export_bid CortexM0_SoC_inst.bid
  bitgen -bit "CortexM0_SoC.bit"
} RESULT]
if {$rc} {
  step_error bitgen
  return -code error $RESULT
