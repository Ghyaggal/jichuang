 ...
 ** File	:	C:/Users/Daggal/Desktop/Cortex-M0/verilog/prj/al_ip/SDRAM_WRITE_FIFO.v
 ** Date	:	2024 05 13
...
module SDRAM_WRITE_FIFO #(parameter DATA_WIDTH_W = 8, 
    ...
    fifo_cross_domain_addr_process_al_SDRAM_WRITE_FIFO #(.ADDR_WIDTH(ADDR_WIDTH_W)) rd_to_wr_cross_inst (.primary_asreset_i(rd_rst), 
    ...
    fifo_cross_domain_addr_process_al_SDRAM_WRITE_FIFO #(.ADDR_WIDTH(ADDR_WIDTH_R)) wr_to_rd_cross_inst (.primary_asreset_i(wr_rst), 
                .secondary_asreset_i(rd_rst), 
                .primary_clk_i(clkw), 
                .secondary_clk_i(clkr), 
                .primary_addr_i(shift_wraddr), 
                .secondary_addr_o(wr_to_rd_addr)) ; 
    ram_infer_SDRAM_WRITE_FIFO #(.DATAWIDTH_A(DATA_WIDTH_W),
...
// ===========================================================================
module fifo_cross_domain_addr_process_al_SDRAM_WRITE_FIFO #(parameter ADDR_WIDTH = 9) (
...
// ===========================================================================
module ram_infer_SDRAM_WRITE_FIFO (clka, 
        rsta, 
        cea, 
        ocea, 
        wea, 
